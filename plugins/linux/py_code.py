...
class Py_Code(interfaces.plugins.PluginInterface):
    ...
    Usage:
      python3 vol.py -f "path/to/mem dump" linux.py_code.Py_Code--pid=<process_id>
        ...
        if modobj_dict:
          ...
          for k, v in modobj_dict.items():
            ...
            if vtype=="function" or vtype=="classmethod":
               ...
               collected_data.append((int(task.pid), code_obj_info.co_name, code_obj_info.co_argcount, code_obj_info.co_nlocals, code_obj_info.co_varnames,disassembled_code))
