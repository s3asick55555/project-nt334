...
class Py_Function(interfaces.plugins.PluginInterface):
    ...
    def get_requirements(cls):
        ...
        - The PESymbolFinder class from elf_symbols plugin to locate _PyRuntime symbol in the dynamic table of PE header
    ...
    def _collect_data(self, processes):
        ...
        Args:
         processes: Iterator of process process objects to analyze
    ...
    def process_module(self, modobj, python_table_name, process):
      ...
      """
        ...
        - Source file location (from func_globals['__loader.path__'])
        ...
        if modobj_dict:
           ...
           for k, v in modobj_dict.items():
            ...
            if vtype=="function" or vtype=="classmethod":
               ...
               collected_data.append((int(process.UniqueProcessId), v_address, func_name_obj.get_value(), func_module_obj.get_value(), file_name_value))
            ...
            if vtype=="type":
               ...
               for k1, v1 in class_dict.items():
                   ...
                   if vtype1=="function" or vtype=="classmethod":
                      ...
                      collected_data.append((int(process.UniqueProcessId), v_address1, func_name_obj.get_value(), func_module_obj.get_value(), file_name_value))
